    ...
    <MotionSection id="experience" className="py-16 sm:py-20">
      <Container>
        <SectionHeading
          ...
          description="Roles where I built production Android features, improved maintainable architecture, and delivered business-focused solutions."
        />
          ...
          <ol className="space-y-6">
            {portfolio.experience.items.map((item, idx) => (
              ...
              >
                ...
                <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-[0_0_0_1px_rgba(0,200,83,0.08)] hover:shadow-[0_0_0_1px_rgba(0,200,83,0.16)] transition-shadow">
                  <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-2">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-slate-300/90">
                        {formatMeta(item) ? formatMeta(item) : item.company || ""}
                      </p>
                    </div>
